...
BitArray.prototype.shift_left = function () {
	for ( var ii = 0; ii < this.size() - 1; ii++ ) {
...
BitArray.prototype.shift_right= function () {
	for ( var ii = this.size() - 1; ii > 0; ii-- ) {
		this.set(ii,this.get(ii-1)); 		
	}
	// set the last one 
	this.set(ii,false);
